...
/// Mem size in MB-bit
#define MEM_FLASH_SIZE 64U        // 64 MB-bit (8 MB)
...
/// Blocks count
#define BLOCK_COUNT 128U          // 128 blocks (64 KB каждый)
/// Sector count
#define SECTOR_COUNT 2048U        // 2048 sectors (4 KB каждый)
/// Pages count
#define PAGE_COUNT 32768U         // 32 768 pages (256 байт каждая)
